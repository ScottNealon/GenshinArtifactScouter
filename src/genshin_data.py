...
This module contains the following data structures:
    ...
    * dropped_from_world_boss - List of artifact sets that come bosses
    * artifact_set_shorthand - Shorthand of artifact sets for logging
"""
...
main_stat_scaling = {
    1: {
        ...
        "Pyro DMG%":         [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
        "Hydro DMG%":        [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
        "Cryo DMG%":         [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
        "Electro DMG%":      [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
        "Anemo DMG%":        [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
        "Geo DMG%":          [3.1, 	4.3, 	5.5, 	6.7, 	7.9],
    ...
    2: {
        ...
        "Pyro DMG%":         [4.2, 	5.4, 	6.6, 	7.8, 	9],
        "Hydro DMG%":        [4.2, 	5.4, 	6.6, 	7.8, 	9],
        "Cryo DMG%":         [4.2, 	5.4, 	6.6, 	7.8, 	9],
        "Electro DMG%":      [4.2, 	5.4, 	6.6, 	7.8, 	9],
        "Anemo DMG%":        [4.2, 	5.4, 	6.6, 	7.8, 	9],
        "Geo DMG%":          [4.2, 	5.4, 	6.6, 	7.8, 	9],
    ...
    3: {
        ...
        "Pyro DMG%":         [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
        "Hydro DMG%":        [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
        "Cryo DMG%":         [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
        "Electro DMG%":      [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
        "Anemo DMG%":        [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
        "Geo DMG%":          [5.2, 	6.7, 	8.2, 	9.7, 	11.2, 	12.7, 	14.2, 	15.6, 	17.1, 	18.6, 	20.1, 	21.6, 	23.1],
    ...
    4: {
        ...
        "Pyro DMG%":         [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
        "Hydro DMG%":        [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
        "Cryo DMG%":         [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
        "Electro DMG%":      [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
        "Anemo DMG%":        [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
        "Geo DMG%":          [6.3, 	8.1, 	9.9, 	11.6, 	13.4, 	15.2, 	17.0, 	18.8, 	20.6, 	22.3, 	24.1, 	25.9, 	27.7, 	29.5, 	31.3, 	33.0, 	34.8],
    ...
    5: {
        ...
        "Pyro DMG%":         [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
        "Hydro DMG%":        [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
        "Cryo DMG%":         [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
        "Electro DMG%":      [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
        "Anemo DMG%":        [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
        "Geo DMG%":          [7.0, 	9.0, 	11.0, 	12.9, 	14.9, 	16.9, 	18.9, 	20.9, 	22.8, 	24.8, 	26.8, 	28.8, 	30.8, 	32.8, 	34.7, 	36.7, 	38.7, 	40.7, 	42.7, 	44.6, 	46.6],
...
substat_rarity = {
    ...
    "Pyro DMG%": _unrelated_substat_rarity,
    "Hydro DMG%": _unrelated_substat_rarity,
    "Cryo DMG%": _unrelated_substat_rarity,
    "Electro DMG%": _unrelated_substat_rarity,
    "Anemo DMG%": _unrelated_substat_rarity,
    "Geo DMG%": _unrelated_substat_rarity,
...
set_stats = {
    ...
    "Adventuerer": [{"HP": 1000}, {}],
    "LuckyDog": [{"DEF": 100}, {}],
    "TravelingDoctor": [{"Healing Bonus%": 20.0}, {}],
    "ResolutionOfSojouner": [{"ATK%": 18.0}, {"Crit Rate%": 30.0}],
    "TinyMiracle": [{}, {}],
    "Berserker": [{"Crit Rate%": 12.0}, {}],
    "Instructor": [{"Elemental Mastery": 80}, {"Elemental Mastery": 120}],
    "TheExile": [{"Energy Recharge%": 20.0}, {}],
    "DefendersWill": [{"DEF%": 30.0}, {}],
    "BraveHeart": [{"ATK%": 18.0}, {"DMG%": 15.0}],
    "MartialArtist": [{"DMG%": 15.0}, {"DMG%": 25.0}],
    "Gambler": [{"DMG%": 20.0}, {}],
    ...
    "GladiatorsFinale": [{"ATK%": 18.0}, {"DMG%": 35.0}],
    "WanderersTroupe": [{"Elemental Mastery": 80}, {"DMG%": 35.0}],
    "Thundersoother": [{}, {"DMG%": 35.0}],
    "ThunderingFury": [{"Electro DMG%": 15.0}, {}],
    "MaidenBeloved": [{"Healing Bonus%": 15.0}, {"Healing Bonus%": 20.0}],
    "ViridescentVenerer": [{"Anemo DMG%": 15.0}, {}],
    "CrimsonWitchOfFlames": [{"Pyro DMG%": 15.0}, {"DMG%": 15.0}],
    "Lavawalker": [{}, {"DMG%": 35.0}],
    "NoblesseOblige": [{"DMG%": 20.0}, {}],
    "BloodstainedChivalry": [{"Physical DMG%": 25.0}, {"DMG%": 50.0}],
    "ArchaicPetra": [{"Geo DMG%": 15.0}, {}],
    "RetracingBolide": [{}, {"DMG%": 40.0}],
    "BlizzardStrayer": [{"Cryo DMG%": 15.0}, {"Crit Rate%": 40.0}],
