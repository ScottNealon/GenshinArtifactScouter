...
class GenshinOptimizerData():
    ...
    def get_artifacts(self, sets: list[str] = None, stars: list[int] = None, min_level: int = None, max_level: int = None, slot: list[type] = None, main_stat: list[str] = None, min_substats: dict[str] = None, equipped: bool = None, location: list[str] = None, locked: bool = None):
    ...
    def _import_artifacts(self):
        ...
        for artifact_name, artifact_data in self.data['artifactDatabase'].items():
            ...
            data = {
                ...
                'substats': {go_stat_map[substat['key']]: substat['value'] for substat in artifact_data['substats'] if substat['key'] != ''}
            }
